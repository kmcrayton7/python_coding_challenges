...
class Bottles(object):
    def __init__(self, starting_bottles_of_beer):
        self.starting_bottles_of_beer = starting_bottles_of_beer
 
        print "How many bottles of beer do you have?"
        self.starting_bottles_of_beer = int(raw_input("> "))
        print "You have %r bottles of beer." % (self.starting_bottles_of_beer)
