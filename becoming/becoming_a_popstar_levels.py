...
def main():
    # level = [ Unknown, Discovered, HotNewArtist, PaidYourDues, AlmostThere ]
    ...
    level_1 = Unknown()
    level_1.career_paths()
    level_2 = Discovered()
    level_2.points = level_1.points
    level_2.career_paths()
    level_3 = HotNewArtist()
    level_3.points = level_2.points
    level_3.career_paths()
    level_4 = PaidYourDues()
    level_4.points = level_3.points
    level_4.career_paths()
    level_5 = AlmostThere()
    level_5.points = level_4.points
    level_5.career_paths()
